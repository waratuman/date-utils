...
(deftest parse-leap-year-month-day2
  (is (= (GregorianCalendar. 2004 1 29)
         (parse "2004-02-29")))
  (is (= (GregorianCalendar. 2000 1 29)
         (parse "2000-02-29"))))
...
(deftest parse-valid-month-dates-test
  ...
  (is (= (GregorianCalendar. 2004 0 31)
         (parse "20040131")))
  (is (= (GregorianCalendar. 2004 2 31)
         (parse "2004-03-31")))
  (is (= (GregorianCalendar. 2004 2 31)
         (parse "20040331")))
  (is (= (GregorianCalendar. 2004 3 30)
         (parse "2004-04-30")))
  (is (= (GregorianCalendar. 2004 3 30)
         (parse "20040430")))
  (is (= (GregorianCalendar. 2004 4 31)
         (parse "2004-05-31")))
  (is (= (GregorianCalendar. 2004 4 31)
         (parse "20040531")))
  (is (= (GregorianCalendar. 2004 5 30)
         (parse "2004-06-30")))
  (is (= (GregorianCalendar. 2004 5 30)
         (parse "20040630")))
  (is (= (GregorianCalendar. 2004 6 31)
         (parse "2004-07-31")))
  (is (= (GregorianCalendar. 2004 6 31)
         (parse "20040731")))
  (is (= (GregorianCalendar. 2004 7 31)
         (parse "2004-08-31")))
  (is (= (GregorianCalendar. 2004 7 31)
         (parse "20040831")))
  (is (= (GregorianCalendar. 2004 8 30)
         (parse "2004-09-30")))
  (is (= (GregorianCalendar. 2004 8 30)
         (parse "20040930")))
  (is (= (GregorianCalendar. 2004 9 31)
         (parse "2004-10-31")))
  (is (= (GregorianCalendar. 2004 9 31)
         (parse "20041031")))
  (is (= (GregorianCalendar. 2004 10 30)
         (parse "2004-11-30")))
  (is (= (GregorianCalendar. 2004 10 30)
         (parse "20041130")))
  (is (= (GregorianCalendar. 2004 11 31)
         (parse "2004-12-31")))
  (is (= (GregorianCalendar. 2004 11 31)
         (parse "20041231"))))
